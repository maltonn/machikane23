      ...
      <div className="main">
        ...
        <div className="about-sky">
            ...
            <div className="about-mainpage">
                <div className="notes-miniTitle">【重要】11月３日（金）まちかね祭でお配りした非常用飲料水への異物混入について</div>
                <p> 令和５年11月３日（金）、大阪大学安全衛生管理部では、本学豊中キャンパスにおいて、まちかね祭来場者のうちの希望者に、大学備蓄として保管していた非常用の食品及び飲料水（＊）の配布を行いました。</p>
                <p>この度、配布した飲料水（500mlペットボトル）のうち１本について、内容物に白いカビ状の物質が混ざっているとの通報が寄せられました。</p>
                ...
                <p>＊当該飲料水はメーカーが定める賞味期限（2024.07.24）のものであり、期限到来までの日数が１年に満たないことを明示したうえで配布を行ったものです。</p>
