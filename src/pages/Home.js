...
export default function Home() {
  ...
  /* sectionについてのところ */
  const [isSectionOpenA, setIsSectionOpenA] = useState(false)
  ...
  const [isSectionOpenB, setIsSectionOpenB] = useState(false)
  ...
  const [isSectionOpenC, setIsSectionOpenC] = useState(false)
  ...
  const [isSectionOpenD, setIsSectionOpenD] = useState(false)
  ...
  const [isSectionOpenE, setIsSectionOpenE] = useState(false)
        ...
        <div className="mainpage2">
          ...
          <div className="ocean-card">
            ...
            <div className="section-item">
              ...
              <div className="button-parent"><div onClick={onSectionClickA} id="section-button-openA" className={`section-button section-button-open ${isSectionOpenA?"section-closed":"section-opend"}`}>Show All</div></div>
              ...
              <div className="button-parent"><div onClick={onSectionClickA} id="section-button-closeA" className={`section-button section-button-close ${isSectionOpenA?"section-closed":"section-opend"}`}>Close content</div></div>
            </div>


            <div className="section-item">
              <span style={{right:0, color:'#F4E511'}}>ラリー企画</span>
              <div className="button-parent"><div onClick={onSectionClickB} id="section-button-openB" className={`section-button section-button-open ${isSectionOpenB?"section-closed":"section-opend"}`}>Show All</div></div>
              ...
              <div className="button-parent"><div onClick={onSectionClickB} id="section-button-closeB" className={`section-button section-button-close ${isSectionOpenB?"section-closed":"section-opend"}`}>Close content</div></div>
            </div>


            <div className="section-item">
              <span style={{right:0, color:'#F4E511'}}>屋外企画</span>
              <div className="button-parent"><div onClick={onSectionClickC} id="section-button-openC" className={`section-button section-button-open ${isSectionOpenC?"section-closed":"section-opend"}`}>Show All</div></div>
              ...
              <div className="button-parent"><div onClick={onSectionClickC} id="section-button-closeC" className={`section-button section-button-close ${isSectionOpenC?"section-closed":"section-opend"}`}>Close content</div></div>
            </div>


            <div className="section-item">
              <span style={{right:0, color:'#F4E511'}}>ステージ企画</span>
              <div className="button-parent"><div onClick={onSectionClickD} id="section-button-openD" className={`section-button section-button-open ${isSectionOpenD?"section-closed":"section-opend"}`}>Show All</div></div>
              ...
              <div className="button-parent"><div onClick={onSectionClickD} id="section-button-closeD" className={`section-button section-button-close ${isSectionOpenD?"section-closed":"section-opend"}`}>Close content</div></div>
            </div>


            <div className="section-item">
              <span style={{right:0, color:'#F4E511'}}>模擬店企画</span>
              <div className="button-parent"><div onClick={onSectionClickE} id="section-button-openE" className={`section-button section-button-open ${isSectionOpenE?"section-closed":"section-opend"}`}>Show All</div></div>
              ...
              <div className="button-parent"><div onClick={onSectionClickE} id="section-button-closeE" className={`section-button section-button-close ${isSectionOpenE?"section-closed":"section-opend"}`}>Close content</div></div>
            </div>
            </div>
            </div>
          </div>
          ...
          <div className ="ocean-card about">
            ...
            <div className="theme-context">
              ...
              <div className="button-parent"><div onClick={onThemeClick} id="theme-button-open" className={`theme-button ${isThemeOpen?"theme-closed":"theme-opend"}`}>Show All</div></div>
              ...
              <div className="button-parent"><div onClick={onThemeClick} id="theme-button-close" className={`theme-button ${isThemeOpen?"theme-closed":"theme-opend"}`}>Close content</div></div>
            </div>
          </div>
        </div>
